...
#include "mocap_interfaces/msg/detail/target__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mocap_interfaces::msg::Target & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mocap_interfaces::msg::Target & ros_message)
{
  // Member: target_name
  cdr >> ros_message.target_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mocap_interfaces::msg::Target;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mocap_interfaces::msg::Target *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mocap_interfaces::msg::Target *>(
    untyped_ros_message);
...
{
  return &mocap_interfaces::msg::typesupport_fastrtps_cpp::_Target__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mocap_interfaces, msg, Target)() {
  return &mocap_interfaces::msg::typesupport_fastrtps_cpp::_Target__handle;
}
