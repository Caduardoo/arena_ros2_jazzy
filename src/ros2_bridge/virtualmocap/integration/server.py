...
from virtualmocap.vision.multiple_view import *
from virtualmocap.vision.synchronizer import *
from virtualmocap.integration.client import *
from virtualmocap.integration.UDP import *
...
class Server:
    ...
    def update_clients(self, clients):
        ...
        # self.client_addresses = client.address for client in enumerate(self.clients)
        self.client_addresses = [tuple(client.address) for client in self.clients]
        # self.client_addresses = {i: tuple(client.address) 
